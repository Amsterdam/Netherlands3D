...
using AuthorizationCodeFlow = Netherlands3D.Authentication.OAuth2.AuthorizationCodeFlow;

namespace Netherlands3D.Authentication.Clients
{
    public class WebGLGitHubAuth : AuthorizationCodeFlow, IUserInfoProvider
    {
        public WebGLGitHubAuth(Configuration configuration) : base(configuration)
        {
        }

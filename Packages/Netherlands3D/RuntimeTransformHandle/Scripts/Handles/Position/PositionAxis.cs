...
namespace RuntimeHandle
{
    ...
    public class PositionAxis : HandleBase
    {
        ...
        public PositionAxis Initialize(RuntimeTransformHandle p_runtimeHandle, Vector3 p_axis, Color p_color)
        {
            ...
            o.layer = LayerMask.NameToLayer(p_runtimeHandle.layerName);
        ...
        {
            Ray cameraRay = Camera.main.ScreenPointToRay(_parentTransformHandle.inputSystemUIInputModule.point.action.ReadValue<Vector2>());

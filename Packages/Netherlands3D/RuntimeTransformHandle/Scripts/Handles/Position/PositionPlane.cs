...
namespace RuntimeHandle
{
    ...
    public class PositionPlane : HandleBase
    {
        ...
        {
            Ray ray = Camera.main.ScreenPointToRay(_parentTransformHandle.inputSystemUIInputModule.GetLastRaycastResult(0).screenPosition);
        ...
        public override void StartInteraction(Vector3 p_hitPoint)
        {
            ...
            Ray ray = Camera.main.ScreenPointToRay(_parentTransformHandle.inputSystemUIInputModule.point.action.ReadValue<Vector2>());

...
namespace Netherlands3D.ModelParsing
{
	...
	{
		[SerializeField] StringEvent objFileToLoad;
		[SerializeField] StringEvent mtlFileToLoad;
        ...
        private void Awake()
        {
            if (objFileToLoad) objFileToLoad.started.AddListener(OnOBJFileReceived);
			if (mtlFileToLoad) mtlFileToLoad.started.AddListener(OnMTLFileReceived);
